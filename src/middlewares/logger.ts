...
export const pilputLogger = createMiddleware(async (c, next) => {
  ...
  console.log(
    `{"method":"${colors.blue}${method}${colors.reset}",
    "url":"${colors.green}${url}${colors.reset}",
     "latency":"${colors.yellow}${duration}ms${colors.reset}",
     "status":"${tatuscolor}${status}${colors.reset}",
     "requestId":"${colors.blue}${c.get("requestId")}${colors.reset}",
