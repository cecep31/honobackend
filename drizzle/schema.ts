import { pgTable, uniqueIndex, foreignKey, serial, timestamp, uuid, text, bigint, varchar, integer, index, unique, boolean, check, smallserial, bigserial, smallint, char, numeric, primaryKey } from "drizzle-orm/pg-core"
