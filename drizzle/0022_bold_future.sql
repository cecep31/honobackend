...
UPDATE "posts" SET "published_at" = "created_at" WHERE "published" = true AND "published_at" IS NULL;--> statement-breakpoint
CREATE INDEX "idx_posts_published_at" ON "posts" USING btree ("published_at" timestamptz_ops);--> statement-breakpoint
CREATE INDEX "idx_posts_published_visibility" ON "posts" USING btree ("published" bool_ops,"published_at" timestamptz_ops);--> statement-breakpoint
